...
import { FormBuilder,FormControl,Validator,ReactiveFormsModule,FormArray, Validators } from '@angular/forms';
@Component({
...
export class EnrollmentForm {
  ...
  submit(){
    if(this.form.valid){
      const playload = this.form.getRawValue();
      console.log("Enrollment playload:",playload);
