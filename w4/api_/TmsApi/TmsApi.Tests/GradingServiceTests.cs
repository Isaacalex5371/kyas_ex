...
{
    [Fact]
    public void CalcylateLetterGrade_HighScore_ReturnsDistinction()
    {
...
public void CalculateLetterGrade_VariousInputs_ReturnsExpectedLevel(decimal score,decimal maxScore,GradeLevel expected)
{
    var service = new GradingService();
