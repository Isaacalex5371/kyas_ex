...
using static Tms.Api.Dtos.AuthDTOs;
...
public class AuthController:ControllerBase
{
    ...
    public AuthController(UserManager<TmsUser> userManager, RoleManager<IdentityRole> roleManager, TmsDbContext context, TokenService tokenService)
...

    {
        ...
        {
// Prevent account enumeration by returning a generi  response
...
// Ensure requested role exists
...

    {
        ...
        if (!validPassword)
        {
            ...
            return Unauthorized(new { detail = "Invalid Cerdentials." });
        }
